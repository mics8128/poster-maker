...
- 輸入圖片：PNG / JPG / JPEG / WEBP / BMP / TIFF，可用選檔或拖曳載入
- 海報分割：輸出多頁 A4 PDF
- 海報尺寸：2x1 / 1x2、2x2、3x2 / 2x3、3x3、4x2 / 2x4、4x3 / 3x4、4x4、自訂張數、指定 mm 尺寸自動計算張數
- 一張多份：將同一張圖片以 A5、A6、A7 或自訂成品尺寸，最佳排列到單張自訂大小的紙張
- 拼版安全邊界：上、右、下、左分開設定，預設各 15mm；圖片完整保留並等比例放入安全區域，比例不同處留白
- 自動最佳擺放：自動判斷欄列反向、A4 直/橫向，或拼版成品是否旋轉 90°
- 預覽：顯示圖片、紙張、裁切線、安全邊界與海報對齊框
- 海報分割預設：重疊 5mm，邊界 1mm
